...
\begin{itemize}
    ...
    \item Place a resistor between \textbf{G21} and the top negative bus (the blue one).
    ...
    \item Finally place a resistor between \textbf{G28} and the top negative bus.
\end{itemize}
...
\begin{itemize}
    ...
    end into any hole on the top negative bus (the blue one). This will provide the ground connection for all components.
    \item Place another black jumper wire between the top negative bus and \textbf{C12}, the GND connection of the OLED.
