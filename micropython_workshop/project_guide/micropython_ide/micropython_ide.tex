...
\begin{figure}[H]
    \centering
    \includegraphics[width=.4\linewidth]{common/viper_ide_usb_choice_connect.png}
    \caption{Click the button highlighted in red.}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\linewidth]{common/viper_connected.png}
