...
\begin{figure}[H]
\centering
    \includegraphics[width=.6\linewidth]{chapter_5/game.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.6\linewidth]{chapter_5/microcontroller_seated_in_breadboard.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.6\linewidth]{chapter_5/components_placed.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.6\linewidth]{chapter_5/all_connected.jpg}
